...
const getEvents = async ()=>{
    ...
    for(let i = 0;i < events.length;i++){
        ...
        <div class="card event-card animate-card">
            <img class="card-img-top" src="${domain}/images/events/${events[i].img}" alt="MIT's unite: open source edition">
            <div class="card-body">
            <span class="badge badge-pill badge-primary p-2 text-white float-right">${events[i].tagline}</span>
    ...
    for(let i = 0;i < events.length;i++){
        ...
        <div class="card event-card animate-card">
            ...
            <div class="card-body">
                ...
                <br>
                <a href="${events[i].link}" target="_blank" class="button animate-button float-right"> Register here</a>
            </div>
        </div>
    </div>
        `;
